...
- When writing tests, look at existing test structure, including existing pytest fixtures in conftest.py. Also consider using pytest's monkeypatch and tmp_path over other ways of patching.
